...
func TestCapabilityPackagesImportOnlyRegistryAndCore(t *testing.T) {
	for _, dir := range []string{"internal/capability/contextmap", "internal/capability/workflow", "internal/capability/workflowai", "internal/capability/workflowrpi", "internal/capability/channel", "internal/capability/checklist", "internal/capability/scrum", "internal/capability/qa"} {
