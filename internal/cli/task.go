...
func newTaskLinkCmd(st *cliState) *cobra.Command {
	...
	list := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return st.emit(st.stdout(), map[string]any{
				"id":    id,
				"out":   edgesToJSON(res.Out),
				"in":    edgesToJSON(res.In),
	...
	add.Flags().StringVar(&id, "id", "", "task id")
	add.Flags().StringVar(&linkType, "type", "", "link type")
	add.Flags().StringVar(&target, "target", "", "target task id")
	_ = add.MarkFlagRequired("id")
	_ = add.MarkFlagRequired("type")
	_ = add.MarkFlagRequired("target")
	remove.Flags().StringVar(&id, "id", "", "task id")
	remove.Flags().StringVar(&linkType, "type", "", "link type")
	remove.Flags().StringVar(&target, "target", "", "target task id")
	_ = remove.MarkFlagRequired("id")
	_ = remove.MarkFlagRequired("type")
	_ = remove.MarkFlagRequired("target")
	list.Flags().StringVar(&id, "id", "", "task id")
	_ = list.MarkFlagRequired("id")
