...
// Cap is the codereview capability. It implements capability.Flow: the
// interface is the kind declaration.
type Cap struct{}
...
// ClaimExprs are the atoms that mean "codereview has decided about this task".
func (Cap) ClaimExprs() []string { return []string{"codereview:*", "codereview-out:*"} }

// FinishLabel is codereview's declared finish socket.
...
// member of codereview-out:* means evicted-by-codereview.
