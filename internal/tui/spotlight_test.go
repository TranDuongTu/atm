...
func TestSpotlightRootRows(t *testing.T) {
	...
	want := []string{"Project", "Task", "Lane", "Reference", "Dispatch a session", "Channels", "Personas", "Profiles & readiness", "Cycle theme", "Setup & readiness"}
	...
	m.projectScope = "ATM"
	m.spotlight.openSpotlight()
	want = []string{"Project", "Task", "Lane", "Reference", "Dispatch a session", "Channels", "Personas", "Profiles & readiness", "Capabilities", "Cycle theme", "Setup & readiness"}
	if got := rowLabels(m); !equalStrings(got, want) {
