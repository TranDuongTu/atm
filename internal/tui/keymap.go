...
var keymapRows = []keyEntry{
	...
	{"Shift+Right/Left", "page events feed", "drill board thumbnail in/out", "-", "-"},
	{"Shift+Up/Down", "scroll events feed", "move thumbnail chart cursor", "-", "-"},
	...
	{"P", "focus activity by persona", "-", "-", "-"},
	{"Ctrl+Up/Down", "move persona cursor", "-", "-", "-"},
	{"Ctrl+Right", "drill into persona / dispatch", "-", "-", "-"},
